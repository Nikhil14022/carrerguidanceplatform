...
const mentorNavItems = [
    { label: 'My Clients', href: '/mentor' },
    { label: 'Workshops', href: '/mentor/workshops' },
    { label: 'Chat', href: '/mentor/chat' },
];
        ...
        <div className="h-full flex flex-col">
            <div className="p-6">
                <div className="flex items-center justify-between">
                    <Link href="/mentor">
                        <h2 className="text-2xl font-bold bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent cursor-pointer hover:opacity-80 transition-opacity">
                            Career Path
                        </h2>
                    </Link>
                </div>
                <p className="text-sm text-slate-500 mt-1">Mentor Portal</p>
            </div>
        ...
        <div className="flex h-screen bg-[#030712] overflow-hidden text-slate-300">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative z-0">
                <header className="bg-slate-950 border-b border-slate-800 p-4 flex items-center justify-between z-10 md:bg-transparent md:border-transparent md:justify-end md:px-8 md:pt-8 md:pb-0">
                    <h1 className="font-bold text-lg text-white md:hidden">Mentor Portal</h1>
