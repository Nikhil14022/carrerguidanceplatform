                        ...
                        filteredModules.map((m) => {
                            ...
                            return (
                                <div key={m.id} className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-xl relative overflow-hidden page-break-after">
                                    ...
                                    {/* Render Scored Test Details if Scored */}
                                    {testType && answers.__scored && (
                                        <div className="bg-slate-950/60 border border-orange-900/20 rounded-2xl p-5 space-y-4">
                                            <div className="text-xs font-bold text-orange-400 uppercase tracking-widest border-b border-slate-900 pb-2">
