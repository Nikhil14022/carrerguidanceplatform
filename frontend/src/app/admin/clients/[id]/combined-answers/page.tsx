    ...
    const handleSaveAnswer = async (moduleId: string, questionId: string, newValue: any, newNotes?: string) => {
        ...
        try {
            ...
            const res = await fetch(`/api/admin/clients/${clientId}/manage`, {
                ...
                body: JSON.stringify({ action: 'EDIT_RESPONSE', moduleId, data: updatedData })
            });
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4 print:border-b print:pb-4">
                <div>
                    <button 
                        ...
                        className="text-xs font-bold text-slate-500 hover:text-orange-400 mb-6 flex items-center gap-2 uppercase tracking-widest transition-colors print:hidden"
                    >
                ...
                <div className="flex gap-3 print:hidden">
                    <button
                        ...
                        className="px-4 py-2.5 rounded-xl border border-orange-500/20 bg-orange-500/10 text-orange-300 text-xs font-bold uppercase tracking-widest hover:bg-orange-500/20 transition-all flex items-center gap-2"
                    ...
                    <button
                        onClick={() => window.open(`/api/mentor/clients/${clientId}/combined-answers/download`, '_blank')}
                        ...
                        title="Download a formatted PDF of all questions and answers"
                    >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="space-y-6 bg-slate-900/40 border border-slate-850 rounded-2xl p-6 print:hidden">
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-orange-500"
                            />
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-200 focus:outline-none focus:border-orange-500"
                        >
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-3">
                            ...
                            <div className="flex gap-2">
                                <button onClick={() => toggleAllFilters(true)} className="text-[10px] text-orange-400 hover:underline">All</button>
                                <span className="text-slate-700 text-[10px]">•</span>
                                <button onClick={() => toggleAllFilters(false)} className="text-[10px] text-orange-400 hover:underline">None</button>
                            </div>
                        </div>
                        ...
                        filteredModules.map((m) => {
                            ...
                            return (
                                <div key={m.id} className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-xl relative overflow-hidden page-break-after">
                                    <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-orange-500/40 via-amber-500/40 to-pink-500/40" />
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-slate-800 pb-4 gap-2">
                                        <div>
                                            <h2 className="text-lg font-bold text-white flex items-center gap-2">
                                                <span className="text-orange-400 font-bold text-sm">#{m.order}</span>
                                                {m.module.title}
                                            </h2>
                                            <p className="text-xs text-slate-500 mt-0.5">{m.module.description}</p>
                                        </div>
                                        <div className="flex gap-2 items-center flex-shrink-0">
                                            <span className="px-2.5 py-0.5 bg-orange-500/10 border border-orange-500/20 text-orange-400 text-[10px] font-bold uppercase tracking-wider rounded-lg">Filled by {m.filledBy}</span>
                                                            ...
                                                            <div className="flex justify-between items-start gap-4">
                                                                ...
                                                                {!isEditingThis && (
                                                                    <button
                                                                        ...
                                                                        className="text-[10px] font-bold text-slate-500 group-hover:text-orange-400 hover:underline transition-colors uppercase tracking-wider shrink-0 mt-0.5 print:hidden"
                                                                    >
                                                                        Edit
                                                                    </button>
                                                                )}
                                                            ...
                                                            {isEditingThis ? (
                                                                <div className="space-y-3 pt-2">
                                                                    ...
                                                                    {q.options ? (
                                                                                ...
                                                                                return (
                                                                                    <button 
                                                                                        ...
                                                                                        className={`px-3 py-1.5 rounded-lg border text-xs font-semibold transition-all ${
                                                                                            isSelected
                                                                                                ? 'bg-orange-500/20 border-orange-500 text-orange-350'
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            className="bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-200 focus:outline-none focus:border-orange-500"
                                                                        >
                                                                                        ...
                                                                                        return (
                                                                                            <div key={rIdx} className={`grid ${colSpanClass} gap-3 items-center`}>
                                                                                                ...
                                                                                                <input 
                                                                                                    ...
                                                                                                    className="w-full bg-slate-900 border border-slate-800 rounded-lg p-2 text-xs text-slate-200 focus:outline-none focus:border-orange-500 disabled:opacity-50"
                                                                                                />
                                                                                                ...
                                                                                                {numCols >= 2 && (
                                                                                                    q.col2Options ? (
                                                                                                        <select
                                                                                                            ...
                                                                                                            className="w-full bg-slate-900 border border-slate-800 rounded-lg p-2 text-xs text-slate-200 focus:outline-none focus:border-orange-500"
                                                                                                        >
                                                                    ...
                                                                    <div className="flex gap-2 pt-1">
                                                                        <button
                                                                            ...
                                                                            disabled={saving}
                                                                            className="px-3 py-1.5 rounded-lg bg-orange-500 text-white text-[10px] font-bold uppercase tracking-widest hover:bg-orange-600 transition-all disabled:opacity-50"
                                                                        >
                                                                            {saving ? 'Saving...' : 'Save'}
                                                                        </button>
                                                                        <button
                                                                ...
                                                                <div className="text-slate-400 text-sm leading-relaxed pl-4 border-l border-slate-800 mt-1 whitespace-pre-wrap">
                                                                    {Array.isArray(value) ? (
                                                                            ...
                                                                            {['school', 'college', 'university'].map(level => {
                                                                                ...
                                                                                return (
                                                                                    <div key={level} className="p-2.5 bg-slate-950/80 rounded-lg text-xs text-slate-300 border border-slate-850">
                                                                                        <span className="font-bold text-orange-400 capitalize">{level}: </span>
                                                                        ...
                                                                        <a href={value} target="_blank" rel="noreferrer" className="text-orange-400 hover:underline flex items-center gap-1.5 text-xs font-semibold">
                                                                            📄 View Document File
                                                                        </a>
                                                                    ) : (
                                                                        (() => {
                                                                    ...
                                                                    {answers[`${q.id}_open_text`] && (
                                                                        <div className="mt-2 text-xs text-orange-400/85 italic bg-orange-500/5 px-3 py-2 rounded-xl border border-orange-500/10 max-w-xl">
