...
export const VALUE_GENRES = ["Personal", "Social", "Achievement", "Physical"] as const;
...
export const SMI_COLUMN_LABELS: Record<string, string> = {
...
export const SD_ROUND1: SDQuestion[] = [
...
export const SD_TEEN: SDQuestion[] = [
...
export const SD_ADULT: SDQuestion[] = [
...
export interface JobFunctionSection {
  title: string;
  category: string;
  items: JobFunctionItem[];
}

export const JF_SECTIONS: JobFunctionSection[] = [
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "jf_t3_r5", text: "Using intuition or nonverbal clues to understand a group or individuals in a group setting" },
